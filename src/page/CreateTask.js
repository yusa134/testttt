...
const CreateTask = (props) => {
  ...
  const handleForSubmit = (e) => {
    ...
    if (formInput.status.trim() === "") {
      ...
      if (formValid) {
        props.onCreateTask(formInput);
      }
  }

  return (
    <>
      <div className="flex justify-center items-center text-left py-10">
        <div className="container px-20">
          ...
          <form onSubmit={handleForSubmit}>
            ...
            <div class="mb-6">          
              ...
              <textarea name='description' onChange={handleInputChange} value={formInput.description} id="deskripsi" rows="2" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Write description here..."></textarea>
